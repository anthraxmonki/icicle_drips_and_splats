...
uint8_t dripColor[] = { 255, 255, 255 }; // Bright white ice
#define PIXEL_PITCH (1.0 / 60.0)    // 150 pixels/m
...
//all pins light up ---- just not in the order I expect or want
...
struct {
  ...
  //36 inches from pixel 17, == 0.9144 meters


  //
  { 35, 17, 0.9000 }, // NeoPXL8 output 0: 35 pixels long, drip pauses at index 7, 0.157 meters above ground

//
  { 35, 18, 0.9000 }, // NeoPXL8 output 1: 35 pixels long, pause at index 6, 0.174 meters up

//
  { 35, 18, 0.9000 }, // NeoPXL8 output 2: etc.

//
  { 35, 17, 0.9000  }, // NeoPXL8 output 3

//
  { 35, 17, 0.9000  }, // NeoPXL8 output 4

//
//  { 35, 18, 0.9000  }, // NeoPXL8 output 5

//
  // { 35, 17, 0.9144 }, // NeoPXL8 output 6
...
//original
//int               longestStrand = (N_DRIPS < 7) ? N_DRIPS : 0;
int               longestStrand = (N_DRIPS < 35) ? N_DRIPS : 0;
